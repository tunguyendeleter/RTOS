 ...
 *****************************************************************************/
/**
 * @brief  This function return reset_handler address of a process
 */
#define GET_PROCESS_ADDRESS(base_ram) \
	*((volatile uint32*)(base_ram + 4))
 ...
 *****************************************************************************/
/**
 * @brief  This function return number of thread
 */
extern uint16 Os_GetNumThread(void);

/**
 * @brief  This function return number of periodic thread
 */
extern uint16 Os_GetNumPeriThread(void);
...
/**
 * @brief  This function set SleepTime to Thread and put Thread to sleep
 */
extern void Os_ThreadSleep(uint32 Time);

#if (THREAD_SLEEP_SUPPORT == STD_ON)
/**
 * @brief  This function is placed in exception handler to update SleepTime
 */
extern void Os_UpdateSleepTime(void);
#endif
